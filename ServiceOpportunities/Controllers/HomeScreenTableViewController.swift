...
class HomeScreenTableViewController: UITableViewController {
    ...
    var companies = [Company(companyName: "TECHO", companyPhone: "(33) 3615 3258", distance: 5, address: "Something Road", image: UIImage(named: "teslacompany") ?? UIImage(), companyDescription: "They build houses."), Company(companyName: "Galilea 2000 A.C.", companyPhone: "(33)3613 2496 / 0443310405808", distance: 6, address: "Yes Boulevard", image: UIImage(named: "teslacompany") ?? UIImage(), companyDescription: "They do things.")]
